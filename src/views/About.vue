<template>
  <div class="about pa-6">
    ...
    <p>
       Lorem Ipsum é um texto modelo da indústria tipográfica 
       ...
       nos anos 60 com a disponibilização das folhas de 
       Letraset, que continham passagens com Lorem Ipsum, 
       e mais recentemente com os programas de publicação 
       como o Aldus PageMaker que incluem versões do Lorem Ipsum.
    </p>
      <p>Lorem Ipsum é um texto modelo da indústria tipográfica 
       e de impressão. O Lorem Ipsum tem vindo a ser o texto 
       padrão usado por estas indústrias desde o ano de 1500, 
       quando uma misturou os caracteres de um texto para criar 
       um espécime de livro. Este texto não só sobreviveu 5 
